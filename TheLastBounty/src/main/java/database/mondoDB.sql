...
-- Creazione tabella per gli oggetti iniziali
CREATE TABLE IF NOT EXISTS Oggetti_Iniziali (
    id INT,
    quantita INT,
    PRIMARY KEY (id, quantita),
...
(102,'Un albero caduto', 'Tra gli alberi noti un albero caduto, sembra essere stato abbattuto da qualcosa oppure da qualcuno, ma non riesci a capire cosa.','In lontananza verso ovest noti una casa, ma non riesci a capire se è abitata o meno.',''),
...
(120,'Uno scheletro','Per caso noti uno scheletro di una persona a terra, sembra essere stato ucciso da qualcosa di molto grande, forse un orso.','Faresti meglio ad allontanarti, nel caso l''orso decida di tornare.',''),
(121,'Un aria strana','Senti che nell''aria c''è qualcosa di strano, forse ti stai avvicinando a qualcosa di importante.','Forse dovresti proseguire per questa strada,sembra che ti stia conducendo da qualche parte.',''),
...
(125,'Un aria strana 2','Senti che nell''aria c''è qualcosa di strano, forse ti stai avvicinando a qualcosa di importante.','Forse dovresti proseguire per questa strada,sembra che ti stia conducendo da qualche parte.',''),
(126,'La fine del bosco','Ti trovi alla fine del bosco, davanti a te intravedi un tempio molto antico vai a nord per scoprire qualcosa.','Vai a nord per trovarti praticamente all''entrata del tempio.',''),
...
(130,'Il tempio','Sei davanti alla porta di entrata del tempio, proprio davanti a te noti una figura alta e robusta, sembra essere un guardiano del tempio.','Se non ci hai ancora parlato, forse potresti trovare un''altra alternativa per entrare nel tempio','è così vuota l''entrata del tempio senza il suo guardiano.'); 
--Tempio
INSERT INTO Casella(id, nome, descrizioneIniziale, descrizioneAggiuntiva, descrizioneAggiornata)
VALUES
...
(333,'La stanza di Vangrath','Entri nella stanza finale del tempio, noti davanti a te un trono e sopra di esso c''è il leggendario Vangrath,sembra però che stia dormendo, guardandoti in torno nella stanza vedi un diamante sopra ad un piedistallo, esso brilla molto e senti un forte richiamo provenire da esso. Cosa vuoi fare?','Vangrath ancora dorme beato, cerca di non fare mosse stupide, la tua vita dipende da questo.','Adesso che hai svegliato Vangrath, puoi provare a parlarci, se non ti uccide prima!'),
...
(337,'Il rumore è dietro l''angolo','Il rumore si fà sempre più forte, noti ad est una porta che socchiusa,prova ad entrarci.','Che cosa stai aspettando? Entra nella stanza.',''),
...
VALUES
(330,'L''atrio','Una volta entrato mel tempo ti trovi in un atrio molto grande, al suo interno noti tante statue di pietra che sembrano raffigurare dei mostri mitologici e sui muri puoi notare tanti quadri molto particolari. Davanti a te noti un portone molto grande, forse dovresti dare un occhiata.','Sei ancora nell''atrio principale, se non hai trovato ancora la chiave puoi esplorare il tempio andando ad [EST] oppure ad [OVEST].','',0),
(339,'verso la seconda guardia','Dopo aver ucciso la prima guardia, ti trovi in un lungo corridoio malridotto.','Vai a [NORD] per continuare, oppure vai a [SUD] per tornare indietro nella stanza della guardia','',0),
...
(102,111,'n'),(111,116,'n'),(116,122,'n'),(122,127,'n'),(126,130,'n'),
...
(104,1,'\n Vedo che hai raccolto un tipo di legno particolare giovane hunter, sento che trabocca di potere magico, cosa vuoi che ci faccia?','','',''),
...
(130,0,'Sono il guardiano del tempio, per proseguire oltre devi rispondere ad una mia domanda fatta in una lingua sconosciuta, se riuscirai a rispondere ti darò l''accesso al tempio.','Complimenti la tua risposta è corretta, adesso potrai accedere al tempio \n','Risponda sbagliata, non sai un cazzo, non ti farò entrare nel tempio perchè sei troppo stupido. \n','');
...
INSERT INTO Oggetti_Iniziali (id,quantita) VALUES
    (1,5),(2,1);
